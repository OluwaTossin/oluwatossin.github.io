  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="rounded-xl border border-border-strong px-4 py-2 text-sm font-semibold text-fg hover:border-accent-border"
            >
              LinkedIn
            </a>
            <a
      ...
      <section className="mt-16">
        <h2 className="mb-6 text-2xl font-bold text-fg">Capabilities &amp; technologies</h2>
        <div className="grid gap-4 sm:grid-cols-2">
          {capabilities.map((c) => (
            <div key={c.title} className="card-surface p-5">
              <h3 className="font-semibold text-accent-muted">{c.title}</h3>
      ...
      <section className="mt-16 grid gap-8 md:grid-cols-2">
        <div className="card-surface p-6">
          <h2 className="text-lg font-bold text-fg">Education</h2>
        ...
        <div className="card-surface p-6">
          <h2 className="text-lg font-bold text-fg">Focus</h2>
          <p className="mt-3 text-sm text-fg-muted leading-relaxed">
